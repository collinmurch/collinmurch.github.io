import{a as v,t as p,d as D}from"../chunks/disclose-version.nKGwhHMC.js";import"../chunks/legacy.C0iA3n7j.js";import{k,t as g,w as M,g as l,x as E,p as G,s as H,aF as C,aG as V,A as Y,v as P}from"../chunks/runtime.CaAVqyjh.js";import{s as O}from"../chunks/render.DGbazWat.js";import{p as R,i as W,o as X,b as z}from"../chunks/index-client.BqtjdMbG.js";import{e as j,i as $,s as b}from"../chunks/attributes.BMgUu-_h.js";import{i as K}from"../chunks/lifecycle.C-85HnmG.js";function J(o,s){var a=o.__className,r=Q(s);k&&o.className===r?o.__className=r:(a!==r||k&&o.className!==r)&&(s==null?o.removeAttribute("class"):o.className=r,o.__className=r)}function Q(o){return o??""}var Z=p('<img class="social">'),ee=p('<a class="svelte-mcuy0a"><!></a>'),te=p("<div></div>");function B(o,s){let a=R(s,"location",8),r=R(s,"links",8);var e=te();j(e,5,r,$,(h,m)=>{var u=ee(),w=M(u);W(w,()=>l(m).type==="image",f=>{var n=Z();g(()=>{b(n,"src",l(m).src),b(n,"alt",l(m).alt)}),v(f,n)},f=>{var n=D();g(()=>O(n,l(m).text)),v(f,n)}),E(u),g(()=>b(u,"href",l(m).href)),v(h,u)}),E(e),g(()=>J(e,`${a()??""} svelte-mcuy0a`)),v(o,e)}const oe=`
