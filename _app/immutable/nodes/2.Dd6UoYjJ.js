import{a as v,t as g,d as P}from"../chunks/disclose-version.DK82h6Cp.js";import"../chunks/legacy.BDaOdGTH.js";import{k as E,t as x,w as B,g as u,x as A,p as R,s as k,aF as M,A as T,v as y}from"../chunks/runtime.DBJxHWlC.js";import{s as U}from"../chunks/render.DqXT1gO6.js";import{p as F,i as N,o as I,b as q}from"../chunks/index-client.BDRLZcwe.js";import{e as D,i as z,s as L}from"../chunks/attributes.CtwjhWcM.js";import{i as G}from"../chunks/lifecycle.CDHfBchB.js";function H(o,i){var r=o.__className,t=V(i);E&&o.className===t?o.__className=t:(r!==t||E&&o.className!==t)&&(i==null?o.removeAttribute("class"):o.className=t,o.__className=t)}function V(o){return o??""}var W=g('<img class="social">'),Y=g('<a class="svelte-mcuy0a"><!></a>'),O=g("<div></div>");function C(o,i){let r=F(i,"location",8),t=F(i,"links",8);var e=O();D(e,5,t,z,(d,s)=>{var m=Y(),c=B(m);N(c,()=>u(s).type==="image",f=>{var l=W();x(()=>{L(l,"src",u(s).src),L(l,"alt",u(s).alt)}),v(f,l)},f=>{var l=P();x(()=>U(l,u(s).text)),v(f,l)}),A(m),x(()=>L(m,"href",u(s).href)),v(d,m)}),A(e),x(()=>H(e,`${r()??""} svelte-mcuy0a`)),v(o,e)}const X=`
