import{a as v,t as g,d as P}from"../chunks/disclose-version.CkL4SF7k.js";import"../chunks/legacy.CN0t40rz.js";import{k as E,t as x,w as B,g as u,x as A,p as R,s as k,aI as M,A as T,v as y}from"../chunks/runtime.BMrqnpKU.js";import{s as U}from"../chunks/render.B4j0a4jI.js";import{p as F,i as I,o as N,b as q}from"../chunks/index-client.DhQbSPgO.js";import{e as D,i as z,s as L}from"../chunks/attributes.BC0uHhoz.js";import{i as G}from"../chunks/lifecycle.Bn2-AoWU.js";function H(o,i){var r=o.__className,t=V(i);E&&o.className===t?o.__className=t:(r!==t||E&&o.className!==t)&&(i==null?o.removeAttribute("class"):o.className=t,o.__className=t)}function V(o){return o??""}var W=g('<img class="social">'),Y=g('<a class="svelte-mcuy0a"><!></a>'),O=g("<div></div>");function C(o,i){let r=F(i,"location",8),t=F(i,"links",8);var e=O();D(e,5,t,z,(d,s)=>{var m=Y(),c=B(m);I(c,()=>u(s).type==="image",f=>{var l=W();x(()=>{L(l,"src",u(s).src),L(l,"alt",u(s).alt)}),v(f,l)},f=>{var l=P();x(()=>U(l,u(s).text)),v(f,l)}),A(m),x(()=>L(m,"href",u(s).href)),v(d,m)}),A(e),x(()=>H(e,`${r()??""} svelte-mcuy0a`)),v(o,e)}const X=`
